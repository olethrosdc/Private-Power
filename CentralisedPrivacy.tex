...
\christos{Who is the competition here? We only have a single provider,
...
\begin{equation}
  ...
  \label{eq:price}
\end{equation}
ensures that at the Nash equilibrium \christos{Who are the players here? The consumers? Does the demand depend on the posted price, or the price on the posted demand? I don't think it makes sense to talk about a long-term equilibrium in a dynamic market..} minimises $\loss_t$, and that the individual cost is
\begin{equation}
  c_t^i = \price_t x_t^i.
  \label{eq:cost}
\end{equation}
